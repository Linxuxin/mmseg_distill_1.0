_base_ = [
    '../../pspnet/pspnet_r18-d8_512x512_40k_ade20k.py'
]
# model settings
...
distiller = dict(
    ...
    teacher_pretrained = 'https://download.openmmlab.com/mmsegmentation/v0.5/pspnet/pspnet_r101-d8_512x512_160k_ade20k/pspnet_r101-d8_512x512_160k_ade20k_20200615_100650-967c316f.pth',
    init_student = False,
    use_logit = True,
...
student_cfg = 'configs/pspnet/pspnet_r18-d8_512x512_40k_ade20k.py'
