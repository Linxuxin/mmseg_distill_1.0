_base_ = [
    '../../deeplabv3/deeplabv3_r18-d8_512x512_40k_voc12aug.py'
]
# model settings
...
distiller = dict(
    ...
    distill_cfg = [ dict(methods=[dict(type='InterClassLoss',
                    ...
                    dict(methods=[dict(type='PairWiseLoss',
                                       name='loss_pa',
                                       loss_weight=1.0,
                                       )
                                ]
...
student_cfg = 'configs/deeplabv3/deeplabv3_r18-d8_512x512_40k_voc12aug.py'
